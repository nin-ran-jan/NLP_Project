...
def train(model, train_data, test_data, learning_rate_bert, learning_rate_lin, epochs, device):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if curr_score > best_score:
            ...
            torch.save(model.bert, "./offensive-model-bert.pth")
        # save best model
...
train_data = CustomSingleDataset(train_dataset[:17842], hate_aug_dataset, 0, tokenizer, "offensive") 
test_data = CustomSingleDataset(train_dataset[17842:], hate_aug_dataset, 0, tokenizer, "offensive")
