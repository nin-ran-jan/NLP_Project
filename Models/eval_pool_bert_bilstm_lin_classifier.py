...
def createCSV(model_preds):
    ...
    with open("/raid/home/vibhu20150/temp/predicitions/preds-bert-bilstm.csv", 'w', encoding='UTF8') as f:
...
model = torch.load("/raid/home/vibhu20150/temp/aug-pooled-bert-2-lin-3-best.pth")
